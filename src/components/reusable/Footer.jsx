    ...
    <footer className="bg-black text-gray-200 py-6 mt-10">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>Tel: {nikosDatos.telefono}</li>
            <li>Dirección: {nikosDatos.direccion}</li>
          </ul>
        </div>
        <div>
          <h3 className="font-semibold text-lg mb-3">Síguenos</h3>
          <div className="flex gap-4 text-xl">
            <a href={nikosDatos.facebook} target="_blank" className="hover:text-white">
            ...
            <a href={nikosDatos.instagram} target="_blank" className="hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="24" height="24">
      ...
      <div className="border-t border-gray-700 mt-10 pt-4 text-center text-sm">
        v.1.0.7 © {new Date().getFullYear()} Nikos. Todos los derechos reservados. 
      </div>
    </footer>
    </div>
  );
